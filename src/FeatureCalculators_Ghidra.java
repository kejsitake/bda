...
public class FeatureCalculators_Ghidra {
	

    public FeatureCalculators_Ghidra( ) {
    }
    ...
    public static void readConfig() throws IOException {
    	//ClassLoader classLoader = FeatureCalculators_Ghidra.class.getClass().getClassLoader();
...
//  						testFiles.renameTo(newFile);
    	...
    	switch(language) {
    		case "c":
    			...
    			break;
    		case "cpp":
    			test_file_paths = Util.listGhidraCPPFiles(testFolder); //use this for preprocessing 
    			break;
    		case "python":
...
//                	dot.delete();
	...
	//   System.out.println("number of unique nodes"+uniqueWords.size()); 
     ...
     public static String[] wordUnigramsCPP(String dirPath) throws IOException{
	 	    ...
	 	    List test_file_paths = Util.listGhidraCPPFiles(dirPath);
	 		  String[] words = null;
	 	    for(int i=0; i< test_file_paths.size(); i++){
	 			String filePath = test_file_paths.get(i).toString();  
